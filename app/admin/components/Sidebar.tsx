...
export default function AdminSidebar({ isDrawerOpen, setIsDrawerOpen }: AdminSidebarProps) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { icon: Menu, label: 'Menu Management', path: '/admin/menu' },
       ...
       { icon: Hammer, label: 'Services', path: '/admin/services' },
       ...
       { icon: NotebookPen, label: 'Blogs', path: '/admin/blogs' },
       ...
       { icon: ReceiptText, label: 'Terms & conditions', path: '/admin/terms-and-conditions' },
